...
const styles = StyleSheet.create({
  ...
  body: { flex: 1 },
  notMemberText: { fontFamily: fonts.sans, fontSize: 14, color: colors.textTertiary, textAlign: 'center' },
  ...
  eventMeta: { fontFamily: fonts.sans, fontSize: 12.5, color: 'rgba(245,239,230,.66)', marginTop: 4 },
  ...
  checkInTitle: { fontFamily: fonts.sansSemibold, fontSize: 18, color: colors.ink, marginBottom: 8, textAlign: 'center' },
  checkInBody: { fontFamily: fonts.sans, fontSize: 14, color: colors.textSecondary, lineHeight: 20, textAlign: 'center', marginBottom: 18 },
  ...
  checkInButtonText: { fontFamily: fonts.sansSemibold, fontSize: 15, color: colors.inkOn },
  editButton: {
  ...
  editButtonText: { fontFamily: fonts.sansSemibold, color: colors.ink, fontSize: 14 },
  segmentBand: {
  ...
  explainer: { fontFamily: fonts.sans, fontSize: 12.5, color: colors.textTertiary, paddingHorizontal: spacing.gutter, paddingTop: 14, paddingBottom: 4 },
  emptyCard: {
  ...
  emptyCardText: { fontFamily: fonts.sans, fontSize: 13, color: colors.textTertiary },
  searchField: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: 8,
  ...
  attendeeName: { fontFamily: fonts.sansSemibold, fontSize: 15.5, color: colors.ink },
  attendeeSubtitle: { fontFamily: fonts.sans, fontSize: 12.5, color: colors.textSecondary },
  topMatchBadge: { fontFamily: fonts.sansSemibold, fontSize: 10.5, color: colors.brass, marginTop: 1 },
  ...
  statusPillText: { fontFamily: fonts.sansSemibold, fontSize: 12, color: colors.inkOn },
