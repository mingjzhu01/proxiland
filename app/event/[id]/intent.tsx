...
const styles = StyleSheet.create({
  ...
  cardLabel: { fontFamily: fonts.sansSemibold, fontSize: 17, color: colors.brass },
  count: { fontFamily: fonts.sansSemibold, fontSize: 11, color: colors.textMuted },
  chipRow: { flexDirection: 'row', flexWrap: 'wrap', gap: 8, marginTop: 12 },
  errorText: { fontFamily: fonts.sans, fontSize: 12, color: colors.error, marginTop: 8 },
  divider: { height: 1, backgroundColor: colors.ruleInner, marginTop: 14, marginBottom: 12 },
  helper: { fontFamily: fonts.sans, fontSize: 15, color: colors.textTertiary, marginBottom: 8 },
  input: { fontFamily: fonts.sans, fontSize: 13, color: colors.ink, minHeight: 40, textAlignVertical: 'top', padding: 0 },
  footer: { marginTop: 12 },
  notNowButton: { paddingVertical: 16, alignItems: 'center' },
  notNowText: { fontFamily: fonts.sansSemibold, color: colors.textTertiary, fontSize: 14 },
});
