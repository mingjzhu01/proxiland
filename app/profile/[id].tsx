...
const styles = StyleSheet.create({
  ...
  name: { fontFamily: fonts.sansSemibold, fontSize: 26, color: colors.ink, marginTop: 8 },
  subtitle: { fontFamily: fonts.sans, fontSize: 13.5, color: colors.textSecondary, textAlign: 'center' },
  verifiedBadge: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: 5,
  ...
  verifiedBadgeText: { fontFamily: fonts.sansSemibold, fontSize: 11, color: colors.liveChipText },
  linkedinLink: { fontFamily: fonts.sansSemibold, color: colors.brass, fontSize: 13, marginTop: 6, textDecorationLine: 'underline' },
  whyCard: {
    width: '100%',
  ...
  modalTitle: { fontFamily: fonts.sansSemibold, fontSize: 24, color: colors.ink },
  modalDivider: { height: 1, backgroundColor: colors.rule, marginTop: 16, marginBottom: 4 },
  fieldLabel: { fontFamily: fonts.sansSemibold, fontSize: 13, color: colors.textTertiary, marginBottom: 4, marginTop: 14 },
  input: { fontFamily: fonts.sans, borderWidth: 1, borderColor: colors.rule, borderRadius: 10, padding: 12, fontSize: 15, color: colors.ink, backgroundColor: colors.surface },
  modalFooter: { marginTop: 20 },
  cancelLink: { alignItems: 'center', marginTop: 14 },
  cancelLinkText: { fontFamily: fonts.sansSemibold, color: colors.textTertiary, fontSize: 14 },
});
