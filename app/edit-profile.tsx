...
const styles = StyleSheet.create({
  ...
  title: { fontFamily: fonts.wordmark, fontSize: 26, marginBottom: 4 },
  subtitle: { fontFamily: fonts.sans, fontSize: 14, color: '#666', marginBottom: 20 },
  ...
  avatarPlaceholderText: { fontFamily: fonts.sans, color: '#888', fontSize: 12 },
  ...
  suggestionText: { fontFamily: fonts.sans, fontSize: 14, color: '#111' },
  fieldLabel: { fontFamily: fonts.sansSemibold, fontSize: 13, color: '#666', marginBottom: 4 },
  input: { fontFamily: fonts.sans, borderWidth: 1, borderColor: '#ddd', borderRadius: 8, padding: 12, fontSize: 15 },
  inputMultiline: { minHeight: 80, textAlignVertical: 'top' },
  sectionLabel: { fontFamily: fonts.sansSemibold, fontSize: 13, color: '#333', marginTop: 14, marginBottom: 8 },
  hint: { fontFamily: fonts.sans, fontSize: 12, color: '#888', marginBottom: 8 },
  ...
  chipText: { fontFamily: fonts.sansSemibold, fontSize: 13, color: '#555' },
  ...
  dropdownText: { fontFamily: fonts.sans, fontSize: 15, color: '#111' },
  dropdownPlaceholder: { fontFamily: fonts.sans, fontSize: 15, color: '#999' },
  ...
  modalTitle: { fontFamily: fonts.sansSemibold, fontSize: 18, marginBottom: 12 },
  ...
  modalRowText: { fontFamily: fonts.sans, fontSize: 16, color: '#111' },
  modalRowTextSelected: { fontWeight: '700' },
  modalCancel: { alignItems: 'center', paddingVertical: 16 },
  modalCancelText: { fontFamily: fonts.sans, fontSize: 15, color: '#666' },
  draftButton: {
    flexDirection: 'row',
    alignItems: 'center',
  ...
  draftButtonText: { fontFamily: fonts.sansSemibold, fontSize: 13, color: '#3b5bdb' },
  ...
  regenerateButtonText: { fontFamily: fonts.sansSemibold, fontSize: 14, color: '#3b5bdb' },
  draftCard: {
  ...
  draftCardLabel: { fontFamily: fonts.sansSemibold, fontSize: 12, color: '#3b5bdb', marginBottom: 6 },
  draftCardBio: { fontFamily: fonts.sans, fontSize: 14, color: '#222', lineHeight: 20, marginBottom: 12 },
  ...
  draftCardButtonPrimaryText: { fontFamily: fonts.sansSemibold, color: '#fff', fontSize: 13 },
  ...
  draftCardButtonSecondaryText: { fontFamily: fonts.sansSemibold, color: '#555', fontSize: 13 },
  draftError: { fontFamily: fonts.sans, fontSize: 12, color: '#a05a2c', marginBottom: 8 },
  bioCaption: { fontFamily: fonts.sans, fontSize: 12, color: '#888', marginTop: -10, marginBottom: 14 },
