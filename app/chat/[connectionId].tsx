...
const styles = StyleSheet.create({
  ...
  headerName: { fontFamily: fonts.sansSemibold, fontSize: 15.5, color: colors.ink },
  headerRole: { fontFamily: fonts.sans, fontSize: 11.5, color: colors.textMuted, marginTop: 1 },
  messageList: { flex: 1 },
  ...
  empty: { fontFamily: fonts.sans, textAlign: 'center', color: colors.textMuted, fontSize: 14, marginTop: 40 },
  ...
  bubbleTextMine: { fontFamily: fonts.sans, color: colors.inkOn, fontSize: 15, lineHeight: 21 },
  bubbleTextTheirs: { fontFamily: fonts.sans, color: colors.ink, fontSize: 15, lineHeight: 21 },
  inputRow: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: 10,
