...
const styles = StyleSheet.create({
  ...
  subtitle: { fontFamily: fonts.sans, fontSize: 13.5, color: colors.textSecondary },
  verifiedBadge: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: 5,
  ...
  verifyChipText: { fontFamily: fonts.sansSemibold, fontSize: 11.5, color: colors.textSecondary },
  ...
  visibilityState: { fontFamily: fonts.sans, fontSize: 15, color: colors.inkOn },
  ...
  previewLineFull: { fontFamily: fonts.sans, fontSize: 16, color: colors.inkOn, marginTop: 10 },
  detailsCard: {
  ...
  securityBannerTitle: { fontFamily: fonts.sansSemibold, fontSize: 14, color: colors.brass },
  securityBannerText: { fontFamily: fonts.sans, fontSize: 13, color: colors.textTertiary, marginTop: 4 },
