...
const styles = StyleSheet.create({
  ...
  askedBadgeText: { fontFamily: fonts.sansSemibold, fontSize: 11, color: colors.brassChipText },
  coffeeBadge: { backgroundColor: colors.liveChipBg, borderRadius: 999, paddingHorizontal: 10, paddingVertical: 4 },
  coffeeBadgeText: { fontFamily: fonts.sansSemibold, fontSize: 11, color: colors.liveChipText },
  ...
  explainer: { fontFamily: fonts.sans, fontSize: 12, color: colors.textTertiary, marginBottom: 14, lineHeight: 17 },
  ...
  meetingLine: { fontFamily: fonts.sans, fontSize: 13.5, color: colors.textSecondary },
  messageQuote: { fontFamily: fonts.sans, fontSize: 14, color: colors.ink, fontStyle: 'italic', marginTop: 12 },
  empty: { fontFamily: fonts.sans, paddingHorizontal: spacing.gutter, paddingBottom: 16, color: colors.textMuted, fontSize: 14 },
  hint: { fontFamily: fonts.sans, paddingHorizontal: spacing.gutter, paddingBottom: 12, color: colors.textMuted, fontSize: 11 },
  sentRow: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: 12,
