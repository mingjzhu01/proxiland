...
const styles = StyleSheet.create({
  ...
  subtitle: { fontFamily: fonts.sans, fontSize: 12.5, color: colors.textTertiary, marginTop: 4 },
  limitMessage: { fontFamily: fonts.sans, fontSize: 12, color: colors.brass, paddingHorizontal: 20, paddingTop: 10 },
  ...
  optionLabel: { fontFamily: fonts.sansSemibold, fontSize: 15, color: colors.ink, flexShrink: 1 },
