...
const styles = StyleSheet.create({
  ...
  livePillText: { fontFamily: fonts.sansSemibold, fontSize: 11.5, color: colors.liveChipText },
  eventName: { fontFamily: fonts.wordmark, fontSize: 33, lineHeight: 38, color: colors.ink },
  organizer: { fontFamily: fonts.sans, fontSize: 14, color: colors.textTertiary, marginTop: 6 },
  descriptionCard: { marginTop: 20 },
  description: { fontFamily: fonts.sans, fontSize: 14.5, lineHeight: 22, color: colors.ink },
  disclosureBlock: {
  ...
  disclosureLabel: {
    ...
    color: colors.brass,
    marginBottom: 8 },
  disclosureBody: { fontFamily: fonts.sans, fontSize: 13.5, lineHeight: 20, color: colors.ink },
