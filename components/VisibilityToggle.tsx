...
const styles = StyleSheet.create({
  ...
  title: { fontFamily: fonts.sansSemibold, fontSize: 18, color: colors.ink },
  prompt: { fontFamily: fonts.sans, fontSize: 14, color: colors.textSecondary, marginBottom: 14, textAlign: 'center' },
  goButton: { backgroundColor: colors.ink, borderRadius: radii.button, paddingVertical: 14, alignItems: 'center', marginTop: 14 },
  goButtonText: { fontFamily: fonts.sansSemibold, color: colors.inkOn, fontSize: 15 },
  statusRow: { flexDirection: 'row', alignItems: 'center', gap: 8 },
  dot: { width: 8, height: 8, borderRadius: 4, backgroundColor: colors.live },
  statusText: { fontFamily: fonts.sans, fontSize: 15, fontWeight: '600', color: colors.ink, flex: 1 },
  stopButton: { alignSelf: 'flex-start', marginTop: 14 },
  stopButtonText: { fontFamily: fonts.sansSemibold, color: colors.error, fontSize: 14 },
});
